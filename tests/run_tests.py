...
TESTS = [
    ...
    "test_logging.py",        # تسجيل الأحداث والأخطاء في ملف دائم (UTF-8)
    "test_dashboard.py",      # لوحة الموسم (HTML): الحساب وسلامة الصفحة
    "test_assistant.py",      # مساعد اسأل بياناتك: النيّة والأجوبة المحسوبة
    "test_i18n.py",           # الواجهة ثنائية اللغة (عربي/إنجليزي)
    "test_app_mode.py",       # وضع التشغيل (حج/عمرة): فصل الملفّات وإخفاء المناسك
    "test_umrah.py",          # برنامج العمرة: الأفواج ومعتمروها والمالية
